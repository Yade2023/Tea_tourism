...
const cityStores = ref({
  ...
  '新北市': [
    ...
    { name: '石碇八卦茶園', feature: '東方美人、蜜香紅茶、文山包種' ,description: '石碇八卦茶園坐落於「台灣小桂林」千島湖山區，層層茶園與碧綠湖水交錯成畫，是新北最壯麗的茶園之一。此地氣候潮濕、日照柔和，適合茶蟬啃咬形成獨特蜜香風味。茶園設有觀景平台與茶席體驗區，遊客可邊品茶邊遠眺湖光山色。每年四月採茶季時，滿山茶芽翠綠，吸引攝影愛好者爭相造訪，是結合自然與茶文化的夢幻場景。', mapUrl: '' },
    { name: '金瓜寮魚蕨步道', feature: '文山包種茶' ,description: '金瓜寮魚蕨步道是新北著名的生態與茶鄉共融路線，全長約2公里，沿途溪流清澈、蕨類豐富，兩側皆為包種茶園。漫步其中可聞茶香隨風飄散，並可在茶農設立的臨時茶席歇腳品茗。當地茶園主多開放採茶體驗，遊客可親手採葉、烘茶、泡茶，了解茶從葉到杯的旅程。春季新芽綠意盎然，夏秋之際霧氣繚繞，彷彿走進一幅山中茶畫。', mapUrl: '' }
  ],
  '桃園市': [
    { name: '大溪老茶廠', feature: '紅茶（紅玉、阿薩姆）、烏龍', description: '日治時期建成並多次修復的製茶工廠，保留老式揉捻機、萎凋槽與乾燥設備，展現台灣紅茶興衰與復興。園區以藍磚、拱廊與玻璃天井呈現工業遺產美學，並設門市提供單品紅茶、冷泡與甜點。建議參與導覽認識製程，再到觀景平台遠眺山谷。可與大溪老街、慈湖步道串聯成一日文化行程。', mapUrl: '' },
    { name: '臺灣客家茶文化館',feature: '多元客家茶、擂茶文化展示',  description: '以客家茶文化為主題的展館，介紹茶產業史、族群飲茶習俗與現代創新。建築坐落丘陵茶景之中，館內規劃互動展、茶室體驗與期間限定市集，能從歷史、器具到風味一覽客家茶文化。建議安排擂茶手作，體驗穀物、花生與茶粉的香氣融合。適合親子與文化路線旅人。', mapUrl: '' },
    { name: '景美山林茶園 × 山月茶屋',feature: '自家栽種紅茶、烏龍（景觀茶屋）',  description: '位於北橫山巒的景觀茶園與茶屋，落地窗面向群峰，視野遼闊。提供自家茶款與簡餐，亦可預約採茶、揉捻等體驗。建議上午走古道、午後在茶屋看雲海與日落；晴雨皆有不同山景氛圍。適合情侶與朋友小旅行，享受『茶在山中』的悠然時光。', mapUrl: '' }
  ],
  '新竹縣': [
    { name: '北埔老街擂茶體驗',feature: '擂茶（茶葉×穀物×花生）',  description: '客家文化重鎮北埔以擂茶聞名，旅人可在老街店家親手研磨茶葉、芝麻與花生，沖入熱水後呈現濃郁堅果香與茶韻。周邊老屋、慈天宮與古井構成歷史街景，適合以步行緩慢品味。建議搭配客家小炒與客家點心，形成一趟『吃在地×喝擂茶』的文化旅程。', mapUrl: '' },
    { name: '十二寮休閒農業區茶園',feature: '東方美人、蜜香紅茶',  description: '十二寮以丘陵茶園、湖泊步道與農村風情著稱，茶園受小綠葉蟬著蜆，孕育出東方美人的蜂蜜果香與柔滑口感。遊客可於茶園散步、品飲茶湯，預約採製體驗或在湖畔咖啡廳享受午後時光。夏季綠意濃、冬季雲霧起，是新竹慢活茶旅的代表。', mapUrl: '' },
    { name: '城市選茶 × 新竹動物園周邊茶館', feature: '台灣單品烏龍、紅茶（城市茶館）', description: '在新竹市區以選茶與手沖為主題的現代茶館興起，強調『從產地到杯中』的透明資訊與風味描述。多數茶館鄰近巨城、動物園或老城區，適合步行串聯。建議以兩款不同海拔的烏龍做盲品，再比較紅玉與阿薩姆的香氣差異，快速建立味譜。', mapUrl: '' }
  ],
  '苗栗縣': [
    { name: '銅鑼茶廠',feature: '東方美人（膨風茶）、蜜香紅茶、烏龍',  description: '銅鑼茶廠位於九湖台地，日夜溫差大、茶園生態多樣，孕育出以小綠葉蟬著蜆而聞名的東方美人茶。園區可參觀製茶流程、茶菁採摘與烘焙設備，並安排聞香、手沖與評茶體驗。建議先走九湖步道遠眺丘陵茶田，再回廠房品飲蜂蜜果香與熟果韻，適合初次接觸客庄茶文化的旅人。', mapUrl: '' },
    { name: '南庄茶鄉 × 桂花巷茶文化',feature: '東方美人、包種、客家擂茶',  description: '南庄老街以桂花巷聞名，周邊山坡分布小型茶園與客家茶食。旅人可在老屋茶館品評東方美人與包種，並體驗擂茶，從研磨茶葉、芝麻到沖泡一氣呵成。建議串連蓬萊溪護魚步道與百年郵便局，安排『生態步道＋老街品茶＋擂茶手作』的一日慢旅，感受客庄人情與茶香。', mapUrl: '' },
    { name: '三義木雕小鎮茶館巡禮', feature: '東方美人、烏龍、紅茶（小農茶）', description: '三義以木雕與鐵道文化出名，同時聚集多家小農茶館。沿勝興車站、龍騰斷橋一帶，常見以手沖、聞香杯呈現的小規模選茶店，主打東方美人與蜜香紅茶。建議先探訪鐵路秘境與綠意山徑，午後進入茶館進行兩款對比試飲，快速建立風味記憶，適合文青路線與輕旅行。', mapUrl: '' }
  ],
  '台中市': [
    { name: '梨山高山茶園',feature: '高山烏龍、清香烏龍',  description: '梨山海拔 1,600–2,000 公尺，日夜溫差大、雲霧繚繞，造就厚實葉質與清透花香。沿中橫公路可見層層梯田與懸谷地形的茶園景觀。當地茶農多提供莊園等級試飲，並分享採收季與焙火差異。建議清晨入山觀日、午后品茗，體驗高山冷冽與茶湯甘甜的對比。', mapUrl: '' },
    { name: '福壽山農場茶園',feature: '高冷烏龍、清香金萱',  description: '福壽山農場以高冷蔬果與茶園聞名，雲霧終日流動，茶樹受涼冷環境調教，茶湯滑順、帶冷礦氣。旅人可循步道穿越果園與茶田，秋季另可賞楓。建議預約莊園品飲或選購限量批次，並視天候安排觀雲海行程，享受高山與茶香交織的純淨感。', mapUrl: '' },
    { name: '中興嶺茶園步道', feature: '翠玉、金萱、清香烏龍', description: '新社中興嶺為台中近郊山丘，林相與茶園交錯，形成親民級的散步路線。沿線茶館主打清香系烏龍，適合搭配輕食與手作甜點。建議上午走步道、午後坐進窗邊茶席，做兩款不同焙度的對比試飲；若自駕，亦可串聯花海季或薰衣草農場，打造半日慢遊。', mapUrl: '' }
  ],
  '彰化縣': [
    { name: '鹿港老街茶藝館',feature: '台灣烏龍、紅玉、冷泡茶',  description: '在鹿港紅磚巷弄間的茶藝館，以老屋木構與古味擺設營造靜謐氛圍，提供多款台灣單品茶與冷泡選擇。適合行程安排於龍山寺、老街與玻璃博物館之後，午後入館歇腳品茗。以聞香杯與小茶點呈現，是結合古城文化與當代喝茶方式的輕旅行提案。', mapUrl: '' },
    { name: '芬園步道 × 茶館午茶',feature: '清香烏龍、花草調飲',  description: '八卦山麓的芬園擁有完善步道與綠蔭林徑，鄰近聚落亦有在地茶館供應清香烏龍與花草調飲。適合安排『晨間健行＋午後午茶』，體驗郊山與茶香的節奏。春天賞桐、冬日觀霧，各有風情；也可串聯草屯與彰化市區，形成周末微旅行。', mapUrl: '' },
    { name: '員林山腳路選茶小店', feature: '單品烏龍、手沖紅茶', description: '員林山腳路沿線散布風格小店，茶飲店主打單品烏龍與手沖紅茶，強調產地資訊與輕食搭配。適合以單車或步行慢慢探店，比較不同焙度與海拔的風味差異。傍晚時分坐在騎樓下喝茶看車流，是員林最在地的日常風景。', mapUrl: '' }
  ],
  '南投縣': [
